...
%>
	 				...
	 				<tr>
	 					...
	 					<td><%=product_price %></td>
	 					<td><%=create_date %></td>
	 					<td style="width: 80px;" ><button type="button" class="btn btn-dark" style="background-color: white; width: 50px; padding:5px;  font-size: 11px;"><a href="../product/goodsUpdate.jsp?product_number=<%=product_number %>">수정</a></button></td>
	 					<td style="width: 80px;"><button type="button" class="btn btn-dark" style="background-color: white; width: 50px; padding:5px;  font-size: 11px;"><a href="../product/goodsDelete.jsp?product_number=<%=product_number %>" st>삭제</a></button></td>
	 				</tr>
 <%
