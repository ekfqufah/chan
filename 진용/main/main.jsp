   ...
   %>
	...
	<table border="1">	
		...
		int j = 0; 
		 ...
		 category_code = Integer.toString(count);
...
%>	
		   	 ...
		   	 <li class="nav-item">   	  
	    		   <div class="card" style="width: 18rem;">
					   <a href="./../cart/goodsDisplay.jsp?product_number=<%=product_number%>"><img src=" <%=path%>\<%=stored_file_namearr[0]%>" style="width: 300px; height: 300px;"></a>
